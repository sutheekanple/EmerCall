package masterple.snru.sc.th.emercall.utility;
...
//    Explicit
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView titleTeTexetView = view1.findViewById(R.id.textViewTitie);
        TextView phoneTextView = view1.findViewById(R.id.textViewTitie);

        imageView.setImageResource(ints[i]);
        titleTeTexetView.setText(titleStrings[i]);
